...
// upload image
            ...
            $validated['teacher_id'] = $teacher->id; // mendapatkan data teacher sesuai id

            $course = Course::create($validated);

            if (!empty($validated['courseKeyPoints'])) {
                foreach ($validated['courseKeyPoints'] as $keyPoint) {
        ...
        try {
            ...
            return redirect()->route('admin.courses.create')->with('error', 'Course created failed!');
            throw $th;
        }
        // $teacher = Teacher::where('user_id', Auth::user()->id)->first();
        // // dd($request->all());
