    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.categories.update', $course) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="thumbnail" class="block mt-1 w-full" type="file" name="thumbnail" value="{{$course->thumbnail}}" required autofocus autocomplete="thumbnail" />
