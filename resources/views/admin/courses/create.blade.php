                ...
                <form method="POST" action="{{ route('admin.courses.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex flex-col gap-y-5">
                            <x-input-label for="CourseKeyPoints" :value="__('CourseKeyPoints')" />
                            @for ($i = 0; $i < 3; $i++)
                                <input type="text" class="py-3 rounded-lg border-slate-300 border" placeholder="Write your copywriting" name="courseKeyPoints[]">
                            @endfor
                        </div>
                        <x-input-error :messages="$errors->get('CourseKeyPoints')" class="mt-2" />
                    </div>
